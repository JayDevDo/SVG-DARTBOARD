...
function sortFinishRoutes( routes ){
	routes.sort( (a, b)=>{ if( a.diff !== b.diff ){return a.diff - b.diff;} return a.text.localeCompare( b.text );});
}
//==============================================================================
